...
export class ChartModel {
    ...
    _internal_updateTimeScale(newBaseIndex, newPoints, firstChangedPointIndex) {
        ...
        if (visibleBars !== null &&
            ...
            const needShiftVisibleRangeOnNewBar = isLastSeriesBarVisible &&
    ...
    _internal_defaultVisiblePriceScaleId() {
        return this._private__options.rightPriceScale.visible
            ? "right" /* DefaultPriceScaleId.Right */
            : "left" /* DefaultPriceScaleId.Left */;
    }
    ...
    _private__createSeries(options, seriesType, pane) {
        ...
        const targetScaleId = options.priceScaleId !== undefined
